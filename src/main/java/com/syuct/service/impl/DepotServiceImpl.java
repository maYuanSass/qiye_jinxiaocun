...
public class DepotServiceImpl implements DepotService {
    ...
    public Map<String, Object> getStoreOutInInfoByPage(int page, int limit) {
        ...
        for (StoreOutInVo s :
                storeOutInVos) {
            Store in= infoMapper.getStoreInfoById(Integer.parseInt(s.getStoreInName()));
            s.setStoreInName(in==null?"":in.getName());
            Store out=infoMapper.getStoreInfoById(Integer.parseInt(s.getStoreOutName()));
            s.setStoreOutName(out==null?"":out.getName());
